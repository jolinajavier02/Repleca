...
import { Download, CheckCircle, Clock, Youtube, Smartphone, Instagram, Send } from 'lucide-react';
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
               <div>
                  ...
                  <select style={{ width: '100%', background: 'var(--bg-dark)', border: '1px solid var(--border)', padding: '12px', borderRadius: '8px', color: 'white' }}>
                     ...
                     <option>720p HD (1280 x 720)</option>
                  </select>
               </div>
               <div>
          ...
          <section className="glass-panel" style={{ padding: '2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(140px, 1fr))', gap: '1rem' }}>
               {[
                 { icon: <Youtube size={20} />, label: 'YouTube 16:9' },
                 { icon: <Smartphone size={20} />, label: 'TikTok 9:16' },
                 { icon: <Instagram size={20} />, label: 'Reels 9:16' },
                 ...
                 <button key={i} style={{ 
                   ...
                   border: i === 0 ? '1px solid var(--accent-mint)' : '1px solid var(--border)', 
                   borderRadius: '12px',
                   color: i === 0 ? 'var(--accent-mint)' : 'var(--text-secondary)',
                   cursor: 'pointer'
                 }}>
                   {preset.icon}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                 <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                    <div style={{ width: '40px', height: '40px', background: 'var(--glass)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyItems: 'center' }}>
                       <CheckCircle size={18} style={{ color: 'var(--accent-mint)', margin: '0 auto' }} />
                    </div>
                    <div>
                 ...
                 <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                    <div style={{ width: '40px', height: '40px', background: 'var(--glass)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyItems: 'center' }}>
                       <Clock size={18} style={{ color: 'var(--accent-blue)', margin: '0 auto' }} />
                    </div>
                    <div style={{ flex: 1 }}>
                       ...
                       <div style={{ width: '100%', height: '4px', background: 'var(--bg-dark)', borderRadius: '10px', marginTop: '4px' }}>
                          <div style={{ width: '64%', height: '100%', background: 'var(--accent-blue)', borderRadius: '10px' }} />
                       </div>
                    </div>
                 </div>
              </div>
